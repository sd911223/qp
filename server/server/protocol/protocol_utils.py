...
from base.commands_s2s import S2S_HEART_BEAT, S2S_SEND
...
# def pack_client_message1(service_type, cmd, data,type):
#     """ 打包客户端消息的完整内容 """
#     return {
#         'cmd': pack_command(service_type, cmd),
#         'msg': data or [],
...
def pack_s2s_heart_beat(cid, from_sid, from_service, with_ack):
    return pack_s2s_package(cid, from_sid, from_service, 0, 0, with_ack, S2S_HEART_BEAT, "")
